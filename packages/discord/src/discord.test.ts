...
describe('Discord contracts', () => {
  it('orders horses by finishing position and prefixes a bold place label after settlement', () => {
    ...
    expect(lines).toEqual([
      '**１着** <:horse_4:1539913571339731024> <:normal:1538151937269301348> 試験馬4  **4.2倍**',
      '**２着** <:horse_1:1539913567787159653> <:normal:1538151937269301348> 試験馬1  **4.2倍**',
      '**３着** <:horse_7:1539913576037490748> <:normal:1538151937269301348> 試験馬7  **4.2倍**',
      '**４着** <:horse_2:1539913568982536253> <:normal:1538151937269301348> 試験馬2  **4.2倍**',
      '**５着** <:horse_5:1539913573206069268> <:normal:1538151937269301348> 試験馬5  **4.2倍**',
      '**６着** <:horse_8:1539913577345851412> <:normal:1538151937269301348> 試験馬8  **4.2倍**',
      '**７着** <:horse_3:1539913570123255808> <:normal:1538151937269301348> 試験馬3  **4.2倍**',
    ...
    const dependencies: PurchaseFlowDependencies = {
      ...
      gateway: {
        ...
        preview: async () => ({
          ...
          minimumPayout: money(0n),
          maximumPayout: money(0n),
